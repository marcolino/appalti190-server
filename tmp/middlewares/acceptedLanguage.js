const parser = require("accept-language-parser"); // TODO: always use this module when parsing language...
...
module.exports = function(props) {
  ...
  return function(req, res, next) {
    ...
    console.info(`requested language: ${req.language}, locale: ${req.locale}`);
